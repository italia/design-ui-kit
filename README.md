...
:star: In questo repo trovi anche un pacchetto di icone, disponibile all'interno del file mastro *Italia-Ui Kit.sketch*, oppure nel file indipendente [*italia-icons.sketch*](https://github.com/italia/design-ui-kit/blob/master/icons/italia-icons.sketch). 
